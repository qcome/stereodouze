...
public class MyCommonEnvironnement extends ActionSupport implements ApplicationAware, SessionAware {
    ...
    public void setApplication(Map<String, Object> map) {
        ...
        if(this.myFacade == null){
            ...
            this.myFacade.createPlaylist(0, "admin", "WEED", "RASTA", arrayList, "1480165052-picsart-11-26-01-56-44.jpg", "Keep Skanking");
            ...
            this.myFacade.createPlaylist(0, "admin", "COCAINE", "GANGSTA", al, "1467827638-issouuuu.jpg", "GHouse oklm");
